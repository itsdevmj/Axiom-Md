...
async function serialize(msg, conn) {
    ...
    try {
            ...
            if (msg.key.participantAlt && msg.key.participantAlt.includes("@s.whatsapp.net")) {
                ...
                try {
                    ...
                    if (participant) {
                        ...
                        console.log("  Participant not found in group metadata");
                    }
                } catch (e) {
        ...
        const isSudoUser = global.SettingsDB.isSudo(user);
        msg.sudo = isSudoUser || msg.key.fromMe;
    } catch (e) {
        console.error("Error checking sudo status:", e);
