const { command, reply, toAudio } = require("../lib");
...
command({
    ...
    switch (res) {
        case "image":
            return message.client.IAS(message.jid, bb, { packname: (m?.pushName || "anonymous"), author: "axiom-md" }, { quoted: m });
            break;

        case "video":
            return message.client.VAS(message.jid, bb, { packname: (m?.pushName || "anonymous"), author: "axiom-md" }, { quoted: m });
            break;
    }
});
